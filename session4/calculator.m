...
% Last Modified by GUIDE v2.5 21-Dec-2018 13:39:58
...
if position == 1
         result=str2double(x)+str2double(y);
elseif position == 2
         result=str2double(x)-str2double(y);
elseif position == 3
         result=str2double(x)*str2double(y);
...
elseif strcmp(x, 'yellow')
    set(handles.text3,'BackgroundColor',[1 1 0]);
elseif strcmp(x, 'magenta')
    set(handles.text3,'BackgroundColor','magenta');
elseif strcmp(x, 'green')
    set(handles.text3,'BackgroundColor','green');
elseif strcmp(x, 'white')
    set(handles.text3,'BackgroundColor','white');
 elseif strcmp(x, 'black')
    set(handles.text3,'BackgroundColor','black');
 elseif strcmp(x, 'blue')
    set(handles.text3,'BackgroundColor','blue');
 elseif strcmp(x, 'cyan')
    set(handles.text3,'BackgroundColor','cyan');
end;
...
if get(handles.radiobutton3,'value') == 1
    x=0:0.1:10;
    y=sin(x);
    %set(get(handles.axes2, 'Parent'), 'HandleVisibility', 'on'); %set handle visibility to on
